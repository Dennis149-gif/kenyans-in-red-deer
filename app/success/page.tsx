      ...
      <section className="max-w-3xl mx-auto px-4 py-20 text-center">
        ...
        <div className="mt-8 rounded-lg bg-black/60 border border-neutral-700 p-6 text-left">
          ...
          <ul className="mt-3 list-disc pl-6 text-neutral-200 space-y-2">
            ...
            <li>Review our <a href="/manifesto" className="text-yellow-300 underline">Manifesto</a>.</li>
          </ul>
        </div>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <a href="/" className="rounded-md border border-neutral-600 px-6 py-3 hover:bg-white/10">
            Back to Home
          </a>
        </div>
      </section>
